...
export default function EditRecipe({ recipe: initialRecipe }: EditRecipeProps) {
  ...
  return (
    <div className="bg-white shadow rounded-lg p-6">
      ...
      <h1 className="text-xl sm:text-2xl font-bold mb-4 sm:mb-6 leading-tight">Edit Recipe</h1>
      ...
      <form onSubmit={handleSave} className="space-y-6">
        ...
        <button
          type="submit"
          className="w-full px-4 py-2 bg-[#088395] text-white rounded hover:bg-[#09637E]"
        >
          Save Recipe
        </button>
      </form>
